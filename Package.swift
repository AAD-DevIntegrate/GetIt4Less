...
// The swift-tools-version declares the minimum version of  WooCommerce\PayPalCommerce\Onboarding required to build this package.

import package

let package =  "WooCommerce\PayPalCommerce\Onboarding" (
